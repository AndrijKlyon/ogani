...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('aboutrecords.index') }}"><i class="fa fa-cube"></i> Записи О магазине</a></li>
        <li class="active"> Добавление записи</li>
    </ol>
</section>
<!-- Main content -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                <form action="{{ route('aboutrecords.store') }}" method="post" data-toggle="validator">
                    @csrf
                    <div class="box-header with-border">
                        <h3 class="box-title">Создание записи О магазине</h3>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="form-group has-feedback">
                            <label for="text" class="control-label">Контент</label>
                            <textarea name="text"
                                        id="editor1"
                                        class="form-control"
                                        cols="80"
