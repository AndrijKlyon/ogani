...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('posts.index') }}"><i class="fa fa-cube"></i> Посты блога</a></li>
        <li class="active"> Добавление поста</li>
    </ol>
</section>
<!-- Main content -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                <form action="{{ route('posts.store') }}" method="post" data-toggle="validator">
                    @csrf
