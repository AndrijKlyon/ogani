@extends('layouts.admin')
 ...
 <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Создание предложения недели</li>
    </ol>
  </section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <form action="{{ route('week_deals.store') }}" method="post" enctype="multipart/form-data" data-toggle="validator">
                            @csrf
                            <div class="box-header with-border">
                                <h3 class="box-title">Создание предложения</h3>
                            </div>
                            <div class="box-body">
                                <div class="form-group has-feedback">
                                    <label for="product_id">Товар, для которого создается акционное предложение</label>
