...
class CommentController extends Controller implements CommentControllerInterface
{
    ...
    public function store(Request $request)
    {
        ...
        // add raiting
        $model_type = $comment->commentable()->associate($model)->commentable_type;
        $user_id = $comment->commenter()->associate(auth()->user())->commenter_id;
        $rating = $request->rating;
        $model_id = $request->commentable_id;
        if(isset($rating) && $rating != '') {
            $this->rate($model_type, $model_id, $user_id, $rating);
        }
        //
    ...
    protected function rate($model, $model_id, $user_id, $rating_value) {
        $rating = new Rating();
        $rating->rating =  $rating_value;
        $rating->rateable_type = $model;
        $rating->rateable_id = $model_id;
